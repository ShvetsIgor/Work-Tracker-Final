export const translations = {
  ru: {
    ...
    fridayOvertime: 'Пятничный расчёт',
    fridayOvertimeInfo: 'После 4ч: 2ч по 125%, далее 150%',
    unpaidLunch: 'Неоплачиваемый обед',
    lunchDuration: 'Длительность обеда (мин)',
    enabledFields: 'Активные поля',
    statisticsFields: 'Поля статистики',
    fieldMileage: 'Пробег',
    ...
    fieldAvgHoursPerShift: 'Часы/смена',
    fieldAvgIncomePerShift: 'Доход/смена',
    fieldExpenseDetails: 'Детализация затрат',
    tipsCardPercent: 'Вычет с чаевых б/н (%)',
    account: 'Аккаунт',
    profile: 'Профиль',
    ...
    totalTipsCash: 'Чаевые нал',
    totalTipsCard: 'Чаевые б/н',
