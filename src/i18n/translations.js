export const translations = {
  ru: {
    ...
    account: 'Аккаунт',
    profile: 'Профиль',
    showShiftsList: 'Список смен',
    hideShiftsList: 'Скрыть смены',
    ...
    thisWeek: 'Неделя',
    thisMonth: 'Месяц',
    currentMonthResults: 'Текущий месяц',
    selectedMonthResults: 'Выбранный месяц',
    monthResultsDescription: 'Количество смен, часы и заработок за месяц.',
  ...
  en: {
    ...
    fridayOvertime: 'Friday Calculation',
    fridayOvertimeInfo: 'After 4h: 2h at 125%, then 150%',
    unpaidLunch: 'Unpaid Lunch',
    lunchDuration: 'Lunch Duration (min)',
    enabledFields: 'Enabled Fields',
    statisticsFields: 'Statistics Fields',
    ...
    fieldAvgHoursPerShift: 'Hours/Shift',
    fieldAvgIncomePerShift: 'Income/Shift',
    fieldExpenseDetails: 'Expense Details',
    ...
    currentMonthResults: 'Current month',
    selectedMonthResults: 'Selected month',
    monthResultsDescription: 'Shifts, hours, and earnings for the month.',
  ...
  he: {
    ...
    fridayOvertime: 'חישוב יום שישי',
    fridayOvertimeInfo: 'אחרי 4 שעות: 2 שעות ב-125%, אח"כ 150%',
    unpaidLunch: 'הפסקת צהריים ללא תשלום',
    lunchDuration: 'משך ההפסקה (דקות)',
    enabledFields: 'שדות פעילים',
    statisticsFields: 'שדות סטטיסטיקה',
    ...
    fieldAvgHoursPerShift: 'שעות/משמרת',
    fieldAvgIncomePerShift: 'הכנסה/משמרת',
    fieldExpenseDetails: 'פירוט הוצאות',
    ...
    thisWeek: 'השבוע',
    thisMonth: 'החודש',
    currentMonthResults: 'החודש הנוכחי',
    selectedMonthResults: 'החודש שנבחר',
    monthResultsDescription: 'משמרות, שעות והכנסות לחודש.',
